  ...
  return (
    <>
      ...
      <div className={styles.starredCard}>
        ...
        {starredWorkflows.map((w, i) => (
          <p
            key={w.id}
            className={`${styles.starredItem} ${i === 1 ? styles.starredItemHighlight : ''}`}
      ...
      {/* Expandable workflows list (collapsed by default) */}
      <div>
        ...
        {isWorkflowsExpanded && (
          <div className={styles.content}>
            {workflows.length === 0 ? (
              <p className={styles.empty}>No workflows yet. Record a new workflow to get started.</p>
            ) : (
